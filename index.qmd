...
img_dimensions <- dim(img)

# Create a plot with dimensions matching the image
plot(1, type = 'n', axes = FALSE, xlab = '', ylab = '', xlim = c(0, img_dimensions[3.5]), ylim = c(0, img_dimensions[2]))

# Display the image with correct dimensions
rasterImage(img, 0, 0, img_dimensions[3.5], img_dimensions[2])
...
# Specify the path to your image file
image_path <- "./images/Seasonal_Comparison.png"
...
# Create a plot with dimensions matching the image
plot(1, type = 'n', axes = FALSE, xlab = '', ylab = '', xlim = c(0, img_dimensions[3.5]), ylim = c(0, img_dimensions[3.5]))

# Display the image with correct dimensions
rasterImage(img, 0, 0, img_dimensions[3.5], img_dimensions[3.5])
```
...
# Specify the path to your image file
image_path <- "./images/Region_Comaprison_by_months.png"
