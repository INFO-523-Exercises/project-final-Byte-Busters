...
`{![Seasonal_Comparison](./images/Seasonal_Comparison.png){fig-align="center"}`
...
`{![Region_Comparison](./images/Region_Comaprison_by_months.png){fig-align="center"}`
...
`{![HeatMap](./images/Correlation_HeatMap.png){fig-align="center"}`
