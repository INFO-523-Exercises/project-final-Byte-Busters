...
format:
  revealjs:
    theme:  ['background-image="images/dallas-united-states-travel-blog.jpg']
editor: visual
execute:
  echo: false
---
...
![](images/google_maps_dallas_metro.png)
...
3.  **Denton**
    1.  Population: 148,146 (202
```
:::

::: {style="flex: 1;"}
```         
<img src="images/google_maps_dallas_metro.png" alt="Dallas Metro Map" width="100%">
```
:::
:::
