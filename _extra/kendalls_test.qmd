...
original_data$TimeOnly <- format(original_data$DATE, "%H:%M")
original_data$TimeOnly

write.csv(original_data, "C:/Users/kendallbeaver/Downloads/time_mutation.csv", row.names = FALSE)
```
