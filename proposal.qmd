...
-   Assess correlations and variances of weather conditions between the three UHIs, then create an interval scale to represent the different intensities of UHI. (correlation matrices, scatter plots, etc.).
