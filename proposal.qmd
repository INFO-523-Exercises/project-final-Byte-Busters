...
-   EDA will be split into two parts:

    1.  **Classification Analysis**

        -   Assess correlations and relationships between UHIs, then create an interval scale that will represent different UHI intensities. (correlation matrices, scatter plots, etc.).
