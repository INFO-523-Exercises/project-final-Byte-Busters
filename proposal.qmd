...
-   The primary objective of this project is to study and analyze climatological data for three cities across the Dallas region and to classify these cities based on an "Urban Heat Island" (UHI) scale. UHI is a climatology term used to describe the subtle yet prolonging effects that a city infrasture can have on amplifying weather conditions. A
