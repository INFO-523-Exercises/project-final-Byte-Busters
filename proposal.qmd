...
modified_arlington <- arlington_data %>% select(columns_to_extract)
...
modified_dallas <- dallas_data %>% select(columns_to_extract)
...
modified_denton <- denton_data %>% select(columns_to_extract)
