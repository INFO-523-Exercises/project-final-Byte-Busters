...
UHI is a term used in the field of climate science, "climatology," to describe the subtle yet powerful effect that a city can have on the weather, such as prolonging heat waves, amplifying or suppressing heavy precipitation -- all of which is called "micro climate."
...
By analyzing and comparing different weather factors across different types of UHIs, we expect to more amplified weather conditions in a larger UHI than a smaller UHI. Additionally, by analyzing various weather conditions for various regions (urban vs. suburban) we can condition trend analysis on this data.
