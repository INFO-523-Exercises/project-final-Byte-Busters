...
-   EDA will be split into two parts based on our questions:
    ...
    2.  **Trend Analysis**
        ...
        -   Perform summary statistics to find central tendencies, correct missing values, and assess outliers.

        -   Identify key time periods of significant UHI intensity.

        -   Create visualizations of temporal trends in UHI intensity, and actionable insights.
