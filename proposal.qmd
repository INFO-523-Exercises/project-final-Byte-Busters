...
UHI is a term used in the field of climate science, "climatology," to describe the subtle yet powerful effect that a dense city can have on amplifying and influencing weather conditions. A UHI is formed when natural land and vegetation are replaced by buildings, pavements, and various surfaces that absorb and retain heat. So, for example, a high-rise building will act as a heat sink during the day and then release that energy after sunset, prolonging the heat and humidity conditions which less dense and suburban areas do not have the problem.

By analyzing and comparing different weather factors, we expect to be able

across different types of cities, we should expect to see an increase in weather conditions in various times throughout the day. Additionally, our analysis will allow us to conduct trend analysis on weather conditions when comparing different cities.
