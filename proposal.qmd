...
Collect, clean, and prepare three climatological datasets for exploratory analysis.

### EDA (**Exploratory Data Analysis)** 

Perform summary statistics across the datasets to find missing values, central tendency values, and outliers.

Clean and remove scarce character data points from numerical columns.
...
Develop classification models for classifying UHI intensities and evaluate their performance.

Working models and performance evaluation report.

### Reporting

Document the processes and results, and then prepare a presentation. Complete project documentation and ready-to-deliver presentation.
