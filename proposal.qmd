...
-   Remove or mutate non-numeric data from numeric columns.
...
-   Assess correlations and variances of weather conditions between the three UHIs, then create an interval scale to represent the different intensities of UHI.
