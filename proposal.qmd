...
UHI is a term used in the field of climate science, "climatology," to describe the subtle yet powerful effect that a city can have on amplifying or suppressing weather conditions (heat waves, precipitation, etc.). A UHI is formed when natural land and vegetation is replaced by a dense concentration of buildings, pavements, and surfaces that absorb heat throughout the day, then release this stored energy after sunset, thus prolonging hot and humid temperatures than what would occur otherwise in a non-UHI or less severe UHI.

By comparing the weather data for the urban city of Dallas vs. two suburban cities outside of Dallas, we can classify different UHI intensity levels. Additionally, we can perform trend analysis on the weather conditions for these cities.
