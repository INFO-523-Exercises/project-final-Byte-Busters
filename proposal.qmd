...
UHI is a term used in the field of climate science, "climatology," to describe the subtle yet powerful effect that a city can have on amplifying or suppressing weather conditions---heat waves, precipitation, etc. A UHI is formed when natural land and vegetation are replaced by buildings, pavements, and surfaces. These objects, particularly high-rise buildings, will absorb heat throughout the day then release the energy after sunset, thus prolonging hot and humid conditions than would otherwise be present.

By comparing the climatological data for the major urban city of Dallas vs. two suburban cities outside of Dallas, we can create a classification system for labeling different types of UHIs, and additionally we can perform trend analysis on this weather data and compare and contrast patterns between these different types of UHIs.
