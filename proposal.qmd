...
UHI, a term used in the field of climate science, occurs when a city replaces natural land and vegetation with buildings, pavements, and surfaces that absorb and hold heat, then release the heat after sunset, which can amplify or suppress weather conditions such as heat waves and heavy precipitation. This effect is also known as "micro climate" because a city is unintentionally controlling and affecting the weather in its environment.
