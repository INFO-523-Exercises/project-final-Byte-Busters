...
-   EDA will be split into two parts based on our questions:
    ...
    1.  **Multi-Class Classification Analysis**

        -   Create a training dataset: Assess climatological relationships and correlations between UHIs, then develop an interval scale that best represents different UHI intensities.
    ...
    2.  **Trend Analysis**
        ...
        -   Collect and verify the accuracy of all graphs and illustrations; select the visualizations with the most meaningful insights that enhance and answers our project objectives.
