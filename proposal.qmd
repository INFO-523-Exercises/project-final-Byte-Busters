...
-   EDA will be split into two parts based on our questions:

    1.  **Classification Analysis**

        -   Create a training dataset: Assess climatological correlations between UHIs, then develop an interval scale that best represents different UHI intensities.

        -   Train data on all types of classification models (Decision Trees, kNN, Random Forest, etc.), evaluate and select models with highest accuracy, then run tests to verify each model's accuracy.

        -   Ensure that all processes and results have been well-documented and are error-free.

    2.  **Trend Analysis**

        -   Perform summary statistics to assess outliers' impact on climatological patterns and identify key time periods across UHI intensities.

        -   Create visualizations of temporal trends in UHI intensity, heat maps, and if possible, find reliable satellite images that captures the amount of vegetation available for the UHIs during this time period.

        -   Ensure that all graphs and visualizations have been throughly analzed and meaningful to our UHI analysis.

### Reporting

-   Compile all reports and visualizations into one report, then prepare and deliver the final presentation on our results and overall assessments of our UHIs.
...
+------------------------------------+----------------------------------------------------------------------------+-----------------------------+
| [**Week 3\                         | Implement Temporal Analysis                                                | *Riyanshi, Kendall, Dhanya* |
...
+------------------------------------+----------------------------------------------------------------------------+-----------------------------+
| [**Week 5 - Presentation\          | Compile project documentation                                              | *Kendall, Dhanya*           |
